...
const Home = () => {
  ...
  return (
    <div className="">
      <div className="w-full fixed top-0 left-0 py-[5px] bg-[#000] hidden z-20 px-[20px] md:flex items-center justify-between border-b border-[#2b2b2b] smm:py-[10px]">
        <h1 className="text-[#FFF] text-[25px] py-[10px] smm:hidden">
          <svg
        ...
        <div className="flex items-center gap-x-[20px]">
          <div className=" bg-[#262626] flex items-center rounded-[5px] w-[268px]">
            <h1 className="text-[#FFF] text-[25px] px-[10px]">
              <svg
                aria-label="Поиск"
            ...
            <input
              type="text"
              className="py-[8px] px-[10px] w-full bg-transparent outline-none text-[#FFF] placeholder:text-[#ABABAB]"
              placeholder="Поиск"
            />
          </div>
          <h1 className="text-[#FFF] text-[25px] smm:hidden">
            <svg
              ...
              <div className="max-w-[500px] mx-auto sm:w-full ">
                ...
                <div className="py-[10px]">
                  ...
                  >
                    ...
                    <SwiperSlide className="w-full max-h-[585px]">
                      <div className="flex items-center justify-center">
                        <img src="https://images.unsplash.com/photo-1554080353-a576cf803bda?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8cGhvdG98ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=500&q=60" alt="" className="w-full" />
                      </div>
                    </SwiperSlide>
                  </Swiper>
                </div>
                ...
                <div>
                  <h1 className="text-[#FFF] font-[600] py-[10px] sm1:px-[10px]">
                    417 отметок "Нравится"
                  </h1>
                </div>
