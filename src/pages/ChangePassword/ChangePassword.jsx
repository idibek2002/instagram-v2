...
const ChangePassword = () => {
  return (
    <div>
      ...
      <div className="max-w-[950px] mx-auto py-[30px] px-[10px]">
        <div className="border border-[#343434] w-full flex">
          <div className=" border border-[#343434] w-[380px] md:hidden">
            <ul className="text-[#FFF] flex flex-col border-b border-[#343434] pb-[80px]">
              <Link to={"/account/edit"} className="py-[15px] hover:bg-[#171717] px-[30px] text-[13px]">
          ...
          <div className="w-full py-[30px] md:h-[85vh]">
            <div className="w-[90%] mx-auto flex flex-col gap-y-[20px]">
              <div className="flex gap-x-[30px] items-center md:gap-x-[10px]">
                <div className="w-[20%] flex items-center justify-end md:justify-start ">
              ...
              <div className="flex gap-x-[30px] items-center md:flex-col md:items-start">
                <div className="w-[20%] md:w-full">
                  <h1 className="text-[#FFF] font-[600] text-end md:text-start md:py-[5px]">
                    Старый пароль
                  </h1>
                </div>
                <div className="w-[70%] md:w-full">
                  <input
                    type="password"
                    className="w-[100%] bg-[#121212] py-[8px] rounded-[8px] text-[#FFF] px-[10px] outline-none border border-[#222]"
                  />
                </div>
              </div>
              <div className="flex gap-x-[30px] items-center md:flex-col md:items-start">
              ...
              <div className="flex items-center gap-x-[15px] py-[10px] md:flex-col">
