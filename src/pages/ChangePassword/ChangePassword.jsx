  ...
  return (
    <div>
      <div className="w-full fixed top-0 left-0 py-[5px] bg-[#FFF] dark:bg-[#000] hidden z-20 px-[20px] md:flex items-center border-b border-[#e5e5e5] dark:border-[#2b2b2b] smm:py-[5px]">
        <Link to={"/account"} className="text-[#000] dark:text-[#FFF] text-[25px] py-[5px]">
        <div className="">
                    <div>
      ...
      <div className="max-w-[950px] mx-auto py-[30px] px-[10px]">
        <div className="border border-[#e5e5e5] dark:border-[#2b2b2b] w-full flex">
          <div className=" border border-[#e5e5e5] dark:border-[#2b2b2b] w-[380px] md:hidden">
            <ul className="text-[#000] dark:text-[#FFF] flex flex-col border-b border-[#e5e5e5] dark:border-[#2b2b2b] pb-[80px]">
              <Link to={"/account/edit"} className="py-[13px] hover:bg-[#ebebeb] dark:hover:bg-[#171717] px-[30px] text-[13px]">
