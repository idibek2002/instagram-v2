...
const Edit = () => {
  return (
    <div>
      <div className="w-full fixed top-0 left-0 py-[5px] bg-[#000] hidden z-20 px-[20px] md:flex items-center border-b border-[#2b2b2b] smm:py-[5px]">
        <Link to={"/account"} className="text-[#FFF] text-[25px] py-[5px]">
          <svg
            aria-label="Назад"
        ...
        <h1 className="text-[#FFF] text-[15px] px-[5px] font-[600] text-center flex items-center justify-center">
            Редактировать профиль
            </h1>
        </div>
      </div>
      <div className="max-w-[950px] mx-auto py-[30px] px-[10px] sm:pt-[40px] sm:px-0">
        <div className="border border-[#343434] w-full flex">
          <div className=" border border-[#343434] w-[380px] md:hidden">
            <ul className="text-[#FFF] flex flex-col border-b border-[#343434] pb-[80px]">
              <Link className="py-[15px] hover:bg-[#171717] px-[30px] text-[13px] font-[700] border-l-[2px]">
                Редактировать профиль
              </Link>
              <Link className="py-[15px] hover:bg-[#171717] px-[30px] text-[13px]">
                Профессиональный аккаунт
              </Link>
              <Link
                to={"/account/password/change"}
                className="py-[15px] hover:bg-[#171717] px-[30px] text-[13px]"
              >
                Сменить пароль
              </Link>
              <Link className="py-[15px] hover:bg-[#171717] px-[30px] text-[13px]">
              ...
              <Link className="py-[15px] hover:bg-[#171717] px-[30px] text-[#0095F9] font-[600] text-[12px]">
            ...
            <div className="px-[30px] py-[20px]">
              ...
              <h1 className="text-[#0095F9] font-[700] py-[15px]">
                Центр аккаунтов
              </h1>
          ...
          <div className="w-full py-[30px]">
            <div className="w-[90%] mx-auto flex flex-col gap-y-[20px]">
              ...
              <div className="flex gap-x-[20px] md:flex-col">
                <div className="w-[30%]">
                  <h1 className="text-[#FFF] font-[500] text-end md:text-start">
                    Имя
                  </h1>
                </div>
                <div className="w-[60%] md:w-full">
                  <input
                    type="text"
                    className="w-[90%] bg-transparent py-[5px] text-[#FFF] px-[10px] border"
                  />
                  <h1 className="text-[#A8A8A8] text-[12px] py-[10px]">
                    Чтобы людям было проще находить ваш аккаунт, используйте
                    имя, под которым вас знают: ваше имя и фамилию, никнейм или
                    название компании.
                  </h1>
              ...
              <div className="flex  gap-x-[20px] md:flex-col">
                <div className="w-[30%] text-end md:text-start md:w-full py-[5px]">
                  <h1 className="text-[#FFF] font-[500]">Имя пользователя</h1>
                </div>
                <div className="w-[60%] md:w-full">
                  <input
                    type="text"
              ...
              <div className="flex  gap-x-[20px] md:flex-col">
                <div className="w-[30%] text-end md:text-start md:w-full">
                  <h1 className="text-[#FFF] font-[500]">Сайт</h1>
                </div>
                <div className="w-[60%] md:w-full">
                  <input
                    type="text"
                    disabled
                    placeholder="Сайт"
                    className="w-[90%] bg-[#202020] border-none py-[5px] px-[10px] border"
                  />
                  <h1 className="text-[#A8A8A8] text-[12px] py-[10px]">
                    В большинстве случаев у вас будет ещё 14 дней, чтобы снова
                    изменить имя пользователя на idibek_02. Подробнее
              ...
              <div className="flex  gap-x-[20px] md:flex-col">
                <div className="w-[30%] text-end md:text-start md:w-full">
                  <h1 className="text-[#FFF] font-[500]">О себе</h1>
                </div>
                <div className="w-[60%] md:w-full">
                  <textarea
                    type="text"
                    ...
                    className="w-[90%] bg-transparent text-[#FFF] py-[5px] px-[10px] border"
                  />
                </div>
              </div>
              <div className="flex  gap-x-[20px] md:flex-col">
                <div className="w-[30%] text-end md:text-start md:w-full">
                  <h1 className="text-[#FFF] font-[500]"></h1>
                </div>
                <div className="w-[60%] md:w-full">
              ...
              <div className="flex items-center gap-x-[20px] md:flex-col">
                <div className="w-[30%] text-end md:text-start md:w-full">
                  <h1 className="text-[#FFF] font-[500]">Эл. адрес</h1>
                </div>
                <div className="w-[60%] md:w-full">
                  <input
                    type="text"
              ...
              <div className="flex  items-center gap-x-[20px] md:flex-col">
                <div className="w-[30%] text-end md:text-start md:w-full">
                  <h1 className="text-[#FFF] font-[500]">Номер телефона</h1>
                </div>
                <div className="w-[60%] md:w-full">
                  <input
                    type="text"
              ...
              <div className="flex items-center gap-x-[20px] md:flex-col">
                <div className="w-[30%] text-end md:text-start md:w-full">
                  <h1 className="text-[#FFF] font-[500]">Пол</h1>
                </div>
                <div className="w-[60%] md:w-full">
                  <input
                    type="text"
              ...
              <div className="flex items-center gap-x-[20px] md:flex-col">
                <div className="w-[45%] text-end md:text-start md:w-full">
                  <h1 className="text-[#FFF] font-[500]">
                ...
                <div className="w-[100%] flex items-center gap-x-[10px] ">
                  <input
                    type="checkbox"
                    className=" bg-transparent text-[#FFF] py-[5px] px-[10px] border"
                  />
                  <h1 className="text-[#A8A8A8] text-[12px] py-[10px]">
                    Выберите, если хотите, чтобы люди могли видеть похожие
                    рекомендуемые аккаунты в вашем профиле, а ваш аккаунт можно
                    было рекомендовать в других профилях.[?]
                  </h1>
                </div>
              </div>
              <div className="flex items-center gap-x-[20px] md:flex-col">
                ...
                <div className="w-[100%] flex items-center justify-between gap-x-[10px] sm:flex-col sm:gap-y-[10px] ">
                  <button className="py-[5px] px-[15px] bg-[#0095F6] text-[#FFF] rounded-[10px]">
                    Отправить
                  </button>
