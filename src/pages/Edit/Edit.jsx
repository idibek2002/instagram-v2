            ...
            <div className="w-[90%] mx-auto flex flex-col gap-y-[20px]">
              ...
              <div className="flex  gap-x-[20px] md:flex-col">
                <div className="w-[30%] text-end md:text-start md:w-full py-[5px]">
                  <h1 className="text-[#000] dark:text-[#FFF] font-[500]">Имя пользователя</h1>
                </div>
                <div className="w-[60%] md:w-full">
                  <input
                    type="text"
              ...
              <div className="flex  gap-x-[20px] md:flex-col">
                <div className="w-[30%] text-end md:text-start md:w-full">
                  <h1 className="text-[#000] dark:text-[#FFF] font-[500]">Сайт</h1>
                </div>
                <div className="w-[60%] md:w-full">
                  <input
                    type="text"
              ...
              <div className="flex  gap-x-[20px] md:flex-col">
                <div className="w-[30%] text-end md:text-start md:w-full">
                  <h1 className="text-[#000] dark:text-[#FFF] font-[500]">О себе</h1>
                </div>
                <div className="w-[60%] md:w-full">
                  <textarea
                    type="text"
              ...
              <div className="flex items-center gap-x-[20px] md:flex-col">
                <div className="w-[30%] text-end md:text-start md:w-full">
                  <h1 className="text-[#000] dark:text-[#FFF] font-[500]">Эл. адрес</h1>
                </div>
                <div className="w-[60%] md:w-full">
                  <input
                    type="text"
              ...
              <div className="flex  items-center gap-x-[20px] md:flex-col">
                <div className="w-[30%] text-end md:text-start md:w-full">
                  <h1 className="text-[#000] dark:text-[#FFF] font-[500]">Номер телефона</h1>
                </div>
                <div className="w-[60%] md:w-full">
                  <input
                    type="text"
              ...
              <div className="flex items-center gap-x-[20px] md:flex-col">
                <div className="w-[30%] text-end md:text-start md:w-full">
                  <h1 className="text-[#000] dark:text-[#FFF] font-[500]">Пол</h1>
                </div>
                <div className="w-[60%] md:w-full">
                  <input
                    type="text"
