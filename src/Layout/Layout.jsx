...
const Layout = () => {
  ...
  return (
    <>
      <div className="flex bg-[#000] w-full">
        <div className="appBar min-w-[245px] app:min-w-[70px] md:hidden sticky z-40 top-0 left-0 h-screen border-r border-[#2b2b2b] bg-[#000] py-[15px] px-[10px]">
          <div className="logo flex items-center justify-start h-[73px] px-[15px] py-[20px]">
            <h1 className="text-[#FFF] hidden app:block">
              <svg
            ...
            <h1 className="text-[#FFF] text-[25px] app:hidden">
              <svg
                aria-label="Instagram"
                class="_ab6-"
                color="rgb(245, 245, 245)"
          ...
          <div className="pt-[20px] flex flex-col justify-between h-[90%] bg-[#000]">
            <ul className="flex flex-col gap-y-[5px]">
              <Link
                to={"/"}
                className="flex items-center gap-x-[15px] h-[50px] p-[12px] rounded-[10px] hover:bg-[#1f1f1f] cursor-pointer"
              >
                ...
                <h1
                  className="text-[15px] font-[600] text-[#F5F5F5] app:hidden"
                  style={
                    location.pathname == "/"
                      ? { fontWeight: "600" }
                      : { fontWeight: "500" }
              ...
              <Link className="flex items-center gap-x-[15px] h-[50px] p-[12px] rounded-[10px] hover:bg-[#1f1f1f] cursor-pointer">
                <div className="flex items-center justify-center">
                  <svg
                ...
                <h1 className="text-[14px] font-[500] text-[#F5F5F5] app:hidden">
                  Поисковый запрос
                </h1>
              </Link>
              <Link className="flex items-center gap-x-[15px] h-[50px] p-[12px] rounded-[10px] hover:bg-[#1f1f1f] cursor-pointer">
              ...
              >
                ...
                <h1
                  className="text-[14px] font-[500] text-[#F5F5F5] app:hidden"
                  style={
                    location.pathname == "/account"
                      ? { fontWeight: "600" }
                      : { fontWeight: "500" }
                              ...
                              >
                                <div>
                                  ...
                                  <div
                                    ...
                                    className="mx-[7px] px-[5px] rounded-[7px] py-[8px] hover:bg-[#514f4f] text-[#FFF]"
                                  >
                                    <MenuItem
                                      onClick={handleClose}
                              ...
                              >
                                <div>
                                  <div
                                    ...
                                    className="mx-[7px] px-[5px] rounded-[7px] py-[10px] text-[#FFF] flex items-center justify-between"
                                  >
                                    <div className="flex items-center gap-x-[10px]">
                                      ...
                                      >
                                        ...
                                        <h1 className="text-[#F5F5F5] font-[600]">
                                        Переключить тему
                                      </h1>
                                    </div>
                                  ...
                                  <div className="border-t border-[#5a5a5a] my-[10px] hover:bg-[#514f4f] text-[#F5F5F5]"></div>
                                  <div className="mx-[7px] px-[5px] rounded-[7px] py-[8px] hover:bg-[#514f4f] text-[#F5F5F5] flex items-center justify-between">
                                    <MenuItem
                                      onClick={handleClose}
                                      className="flex items-center gap-x-[10px] py-[50px]"
                                      style={{
        ...
        <div className="appBar w-full border-t  z-20 hidden fixed md:block bottom-0 left-0  border-[#2b2b2b] bg-[#000] px-[10px]">
        ...
        <div className="w-full relative flex flex-col justify-between">
          ...
          <footer className="w-full bg-[#000] flex items-center pt-[20px] pb-[30px] md:hidden">
            <div className="w-full">
              <ul className="flex items-center justify-center flex-wrap gap-x-[15px] gap-y-[5px] text-center">
                <Link className="text-[#A8A8A8] hover:underline text-[12px] text-center">
                  Meta
                </Link>
                <Link className="text-[#A8A8A8] hover:underline text-[12px] text-center">
                  Информация
              ...
              <div className="flex items-center justify-center py-[20px] gap-x-[20px] mx-auto">
                ...
                <p className="text-[#A8A8A8] ">© 2023 Instagram from Meta</p>
              </div>
            </div>
          </footer>
        </div>
      ...
      <div>
        ...
        >
          <DialogContent
            ...
            className="w-[500px] h-[550px] md:w-[260px]"
          >
            <ul className="flex flex-col">
              <h1 className="py-[14px] border-b border-[#414141] text-center text-[#FFF] text-[14px] font-[600]">
                Создание публикации
              </h1>
            </ul>
            <div className="grid place-items-center h-[490px]">
              <div className="flex flex-col items-center">
                ...
                >
                  <title>
                    Значок, соответствующий медиафайлам, например изображениям
                    или видео
                  </title>
                  <path
                ...
                <h1 className="text-[#FFF] font-[400] text-[18px] py-[10px]">
                  Перетащите сюда фото и видео
                </h1>
                <div className="py-[15px]">
                  <label
                    htmlFor="files"
                    className="bg-[#0095F6] px-[15px] py-[8px] text-[#FFF] font-[600] rounded-[10px] text-[13px] cursor-pointer  "
                  >
      ...
      <div>
        ...
        >
          ...
          >
            ...
            <div className="flex items-center justify-between py-[10px] px-[15px] border-b border-[#424141]">
              <div>
                <svg
                  aria-label="Назад"
                  class="x1lliihq x1n2onr6"
              ...
              <div>
                <h1 className="text-[#FFF] font-[500]">Создание публикации</h1>
              </div>
              <div>
                <button className="text-[#0095F6]">Поделиться</button>
              </div>
            </div>
            <div className="flex items-start justify-center w-full">
              <div className="w-[500px] h-[500px] object-cover flex items-center justify-center">
                <img src={person1} alt="" className=""/>
              </div>
              <div className="px-[15px] py-[20px] w-[300px]">
              <Stack direction="row" spacing={2} className="flex items-center">
                    ...
                    <div className="py-[15px] w-full">
                      <textarea rows={10} className="w-full h-[180px] bg-transparent text-[#FFF] outline-none" placeholder="Добавьте подпись…" ></textarea>
