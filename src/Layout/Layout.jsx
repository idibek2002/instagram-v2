                  ...
                  <div>
                    ...
                    >
                      {({ TransitionProps, placement }) => (
                        ...
                        >
                          <Paper
                            className="w-[270px] app:ml-[50px] bg-[#FFF]"
                            style={{
                            ...
                            <ClickAwayListener onClickAway={handleClose1}>
                              ...
                              >
                                <div>
                                  ...
                                  <div className="border-t border-[#5a5a5a] my-[10px] hover:bg-[#514f4f] text-[#000] dark:text-[#F5F5F5]"></div>
                                  <div className="mx-[7px] px-[5px] rounded-[7px] py-[8px] hover:bg-[#514f4f] text-[#000] dark:text-[#F5F5F5] flex items-center justify-between">
                                    <MenuItem
                                      onClick={handleClose}
                                      className="flex items-center gap-x-[10px] py-[50px]"
                                      style={{
          ...
          <footer className="w-full bg-[#fff] dark:bg-[#000] flex items-center pt-[20px] pb-[30px] md:hidden">
            <div className="w-full">
              ...
              <div className="flex items-center justify-center py-[20px] gap-x-[20px] mx-auto">
                ...
                <p className="dark:text-[#A8A8A8] text-[#000] ">© 2023 Instagram from Meta</p>
              </div>
            </div>
          </footer>
        </div>
        ...
        >
          ...
          >
            <div className="flex items-center justify-between py-[10px] px-[15px] border-b dark:border-[#424141] border-[#d3d3d3] dark:bg-[#2f2f2f] bg-[#FFF]">
              ...
              <div>
                <button className="text-[#0095F6] font-[600]">Поделиться</button>
              </div>
            </div>
            <div className="flex items-start justify-center w-full md:flex-col bg-[#FFF] dark:bg-[#2f2f2f]">
              ...
              <div className="px-[15px] py-[20px] w-[300px] md:w-full">
                ...
                >
                  ...
                  <h1 className="text-[#000] dark:text-[#FFF] font-[600]">idibek_02</h1>
                </Stack>
